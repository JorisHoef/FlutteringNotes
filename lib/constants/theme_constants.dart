...
class ThemeConstants {
  ...
  static const String fontFamilyElectron = 'Montserrat'; // Always use this font
  ...
  static const String fontFamilySerif = 'SourceSans3';

  static TextTheme ensureFontFamily(TextTheme originalTheme) {
    return TextTheme(
      bodySmall: originalTheme.bodySmall?.copyWith(
            fontFamily: fontFamilyElectron,
            fontSize: fontSizeSmall,
          ) ??
          TextStyle(fontFamily: fontFamilyElectron),
      bodyMedium: originalTheme.bodyMedium?.copyWith(
            fontFamily: fontFamilyElectron,
            fontSize: fontSizeMedium,
          ) ??
          TextStyle(fontFamily: fontFamilyElectron),
      bodyLarge: originalTheme.bodyLarge?.copyWith(
            fontFamily: fontFamilyElectron,
            fontSize: fontSizeLarge,
          ) ??
          TextStyle(fontFamily: fontFamilyElectron),
      headlineSmall: originalTheme.headlineSmall?.copyWith(
            fontFamily: fontFamilyElectron,
          ) ??
          TextStyle(fontFamily: fontFamilyElectron),
      headlineMedium: originalTheme.headlineMedium?.copyWith(
          ...
          TextStyle(fontFamily: fontFamilyElectron),
      headlineLarge: originalTheme.headlineLarge?.copyWith(
            fontFamily: fontFamilyElectron,
          ) ??
          TextStyle(fontFamily: fontFamilyElectron),
      titleSmall: originalTheme.titleSmall?.copyWith(
            fontFamily: fontFamilyElectron,
          ) ??
          TextStyle(fontFamily: fontFamilyElectron),
      ...
      titleLarge: originalTheme.titleLarge?.copyWith(
          ...
          TextStyle(fontFamily: fontFamilyElectron),
      labelSmall: originalTheme.labelSmall?.copyWith(
            fontFamily: fontFamilyElectron,
          ) ??
          TextStyle(fontFamily: fontFamilyElectron),
      labelMedium: originalTheme.labelMedium?.copyWith(
            fontFamily: fontFamilyElectron,
          ) ??
          TextStyle(fontFamily: fontFamilyElectron),
...
List<ThemeModel> predefinedThemes() => [
      ...
      ThemeModel(
        ...
        lightTheme: ThemeModel.buildLightTheme(
          ...
          textTheme: TextTheme(
            bodySmall: TextStyle(
                fontFamily: ThemeConstants.fontFamilyIndigo,
                fontSize: ThemeConstants.fontSizeSmall),
            bodyMedium: TextStyle(
                fontFamily: ThemeConstants.fontFamilyIndigo,
                fontSize: ThemeConstants.fontSizeMedium),
      ...
      ThemeModel(
        ...
        lightTheme: ThemeModel.buildLightTheme(
          ...
          textTheme: TextTheme(
            bodySmall: TextStyle(
                fontFamily: ThemeConstants.fontFamilyGreen,
                fontSize: ThemeConstants.fontSizeSmall),
            bodyMedium: TextStyle(
                fontFamily: ThemeConstants.fontFamilyGreen,
                fontSize: ThemeConstants.fontSizeMedium),
      ...
      ThemeModel(
        ...
        lightTheme: ThemeModel.buildLightTheme(
          ...
          textTheme: TextTheme(
            bodySmall: TextStyle(
                fontFamily: ThemeConstants.fontFamilyRed,
                fontSize: ThemeConstants.fontSizeSmall),
            bodyMedium: TextStyle(
                fontFamily: ThemeConstants.fontFamilyRed,
                fontSize: ThemeConstants.fontSizeMedium),
